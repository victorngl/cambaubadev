...
from .views import calendarios_atividades, materiais_didaticos, CalendariosAtividadesDetailView, ComunicadosDetailView, MateriaisDidaticosDetailView, ComunicadoListView
