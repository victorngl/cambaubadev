...
from .views import oficinas, atividades_extras, atividades_noturnas, InscricaoOficinaCreateView, InscricaoAtividadeExtraCreateView, InscricaoAtividadeNoturnaCreateView, OficinaDetailView, AtividadeExtraDetailView, AtividadeNoturnaDetailView
