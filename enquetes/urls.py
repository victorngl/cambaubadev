...
from .views import enquetes, EnqueteDetailView, RespostaEnqueteCreateView
...
urlpatterns = [
    ...
    path('<int:pk>/resultados', login_required(EnqueteDetailView.as_view(template_name="enquete_resultados_detail.html")), name="enquete_resultados_detail"),
