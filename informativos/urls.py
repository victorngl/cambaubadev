...
from .views import balancetes, balancos_patrimoniais, documentacoes_obras, atas_reunioes, contato_representantes, representantes_turma, BalancetesDetailView, BalancoPatrimonialDetailView, DocumentacaoObraDetailView, AtaReuniaoDetailView
...
urlpatterns = [
    ...
    path('grupo_de_pais_representantes/representantes_turma/', representantes_turma, name="representantes_turma"),
